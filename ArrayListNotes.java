...
public class ArrayListNotes
{
    public static void main(String[] args)
    {
         ...
         * 
         * We have to specify the type of the element in the list in angle brackets
         *      (i.e., < >) after every ArrayList identifier.
         *      
         * Primitives (e.g., int, double, boolean) are not classes and cannot
         *      be specified as the type of the element in a generic. Instead, we
         *      can use the corresponding Wrapper Class (e.g, Integer, Double,
         *      Boolean).
         */
    ...
    public static void removeEvens(ArrayList<Integer> list)
    {
        ...
        for(int i = 0; i < list.size(); i++)
        {
            ...
            if(value % 2 == 0)
            {
                 ...
                 * !!! add a comment about shift left
                 */
                list.remove(i);
                i--;
            }
    ...
    public static int sumList(ArrayList<Integer> list)
    {
         ...
         * 
         *  Java will automatically "unbox" wrapper class objects (Integer)
         *   and assign to variables of primitive types (int).
         */
        for(int value : list)
        {
            sum += value;
            ...
            /*
             * Modifying the list (e.g., add, remove) inside an enhanced for
             *      loop generates a ConcurrentModificationException.
             */
            //list.add(7);
        }
